...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14058 = (0);while(true){
var m_14059 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14059 == null))
{} else
{m_14059.call(null);
if((count_14058 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14060 = (count_14058 + (1));
count_14058 = G__14060;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3628__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3628__auto__)
