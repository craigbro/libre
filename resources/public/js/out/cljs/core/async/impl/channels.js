...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14064 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14064 = (function (val,box,meta14065){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14064.cljs$lang$type = true;
cljs.core.async.impl.channels.t14064.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14064";
cljs.core.async.impl.channels.t14064.cljs$lang$ctorPrWriter = (function (this__4217__auto__,writer__4218__auto__,opt__4219__auto__){return cljs.core._write.call(null,writer__4218__auto__,"cljs.core.async.impl.channels/t14064");
});
cljs.core.async.impl.channels.t14064.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14064.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14066){var self__ = this;
var _14066__$1 = this;return self__.meta14065;
});
cljs.core.async.impl.channels.t14064.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14066,meta14065__$1){var self__ = this;
var _14066__$1 = this;return (new cljs.core.async.impl.channels.t14064(self__.val,self__.box,meta14065__$1));
});
cljs.core.async.impl.channels.__GT_t14064 = (function __GT_t14064(val__$1,box__$1,meta14065){return (new cljs.core.async.impl.channels.t14064(val__$1,box__$1,meta14065));
});
}
return (new cljs.core.async.impl.channels.t14064(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14067 = self__.takes.pop();if((taker_14067 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14067))
{var take_cb_14068 = cljs.core.async.impl.protocols.commit.call(null,taker_14067);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14068,taker_14067,this$__$1){
return (function (){return take_cb_14068.call(null,null);
});})(take_cb_14068,taker_14067,this$__$1))
);
} else
{}
{
